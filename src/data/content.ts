...
export type Track = { n: number; name: string; time: string; fav?: boolean };
...
export const TRACKLISTS: Record<string, Track[]> = {
  "nolimit,": [
    { n: 1, name: "rookie", time: "3:43" },
    { n: 2, name: "crank the bass, play the muzik", time: "3:28" },
    { n: 3, name: "shake!the!city!", time: "3:16" },
    { n: 4, name: "fw me (dirty)", time: "2:50" },
    { n: 5, name: "dance or dead", time: "2:53" },
    { n: 6, name: "party! (dance alone)", time: "2:40" },
    { n: 7, name: "select@", time: "2:44" },
    { n: 8, name: "come aliv3", time: "3:27" },
    { n: 9, name: "ready 2", time: "2:47" },
    ...
    { n: 14, name: "feel U luv Me", time: "3:54" },
    { n: 15, name: "hold my hand", time: "4:26" },
    { n: 16, name: "day1s", time: "3:07" },
    { n: 17, name: "nolimit", time: "2:36" },
  ],
  "SMILE! :D": [
    { n: 1, name: "Knock Yourself Out XD", time: "2:48", fav: true },
    { n: 2, name: "Cheerleader", time: "3:58", fav: true },
    { n: 3, name: "Russian Roulette", time: "6:29" },
    { n: 4, name: "Perfect Pinterest Garden", time: "2:29" },
    { n: 5, name: "Year of the Cup", time: "4:23" },
    { n: 6, name: "Kitsune Maison Freestyle", time: "3:55" },
    { n: 7, name: "Easier to Love You", time: "4:11" },
    { n: 8, name: "Mona Lisa", time: "3:45" },
    { n: 9, name: "Is There Really No Happiness?", time: "3:20" },
    { n: 10, name: "Everything To Me", time: "4:47" },
  ],
  "Killswitch Melodies": [
    { n: 1, name: "The Beginning", time: "2:55" },
    { n: 2, name: "Event Horizon", time: "2:45" },
    { n: 3, name: "Birdsong", time: "3:58" },
    { n: 4, name: "Melody From A Dream", time: "3:09" },
    { n: 5, name: "Run On Sentence", time: "3:34" },
    { n: 6, name: "The Edge Of Memory", time: "2:57" },
    { n: 7, name: "Pattern Recognition", time: "2:37" },
    { n: 8, name: "Riff 2", time: "2:44" },
    { n: 9, name: "Immaterial", time: "2:15" },
    { n: 10, name: "Scattered", time: "2:50" },
    { n: 11, name: "Scattered (Instrumental)", time: "2:50" },
  ],
  "无限意识 Meta Ego": [
    { n: 1, name: "Manta", time: "3:22" },
    { n: 2, name: "玫瑰星云 Holy", time: "2:48" },
    { n: 3, name: "潘洛斯阶梯 Penrose", time: "2:24" },
    { n: 4, name: "黑洞 Metropolis", time: "4:18" },
    { n: 5, name: "地球蓝 Aqua Blue", time: "2:55" },
    { n: 6, name: "Whenever", time: "3:15" },
    { n: 7, name: "健忘 Amnesia", time: "4:03" },
    { n: 8, name: "Mind Reader", time: "3:14" },
    { n: 9, name: "捉迷藏", time: "4:16" },
  ],
  "Comfort in Chaos": [
    { n: 1, name: "Comfort In Chaos", time: "4:27" },
    { n: 2, name: "Tears (with Paige Cavell)", time: "3:56" },
    { n: 3, name: "Stay With Me", time: "4:22" },
    { n: 4, name: "Shiver", time: "3:54" },
    { n: 5, name: "EAT THE BASS", time: "3:23" },
    { n: 6, name: "comedown", time: "1:55" },
    { n: 7, name: "Resonate (feat. Julia Church)", time: "4:02" },
    { n: 8, name: "Give Me Anything", time: "3:38" },
    { n: 9, name: "Where You Are", time: "3:56" },
    { n: 10, name: "Undo (feat. KOATES)", time: "4:15" },
    { n: 11, name: "Go Back (feat. Julia Church)", time: "3:41" },
    { n: 12, name: "palm of my hands", time: "2:11" },
  ],
  "130 Mood: TRBL": [
    { n: 1, name: "어때", time: "2:13" },
    { n: 2, name: "풀어", time: "3:32" },
    { n: 3, name: "Bonnie & Clyde", time: "3:45" },
    { n: 4, name: "What 2 Do", time: "3:44" },
    { n: 5, name: "D (Half Moon)", time: "3:49" },
    { n: 6, name: "I Love It", time: "3:37" },
    { n: 7, name: "21", time: "3:27" },
  ],
  "Demidevil": [
    { n: 1, name: "Daisy", time: "2:27" },
    { n: 2, name: "Toxic", time: "2:43" },
    { n: 3, name: "Deal With It (feat. Kelis)", time: "3:11" },
    { n: 4, name: "Slumber Party (feat. Princess Nokia)", time: "2:58" },
    { n: 5, name: "Drunk With My Friends", time: "2:08" },
    { n: 6, name: "Little Boy", time: "2:53" },
    { n: 7, name: "Cry (feat. Grimes)", time: "2:07" },
    { n: 8, name: "L8r Boi", time: "2:24" },
    { n: 9, name: "Good While It Lasted", time: "3:03" },
  ...
  "Alone at Prom": [
    ...
    { n: 4, name: "The Color Violet", time: "3:46" },
    { n: 5, name: "Lavender Sunflower", time: "2:32" },
    { n: 6, name: "Ballad of a Badman", time: "4:15" },
    { n: 7, name: "Lady Of Namek", time: "3:14" },
    { n: 8, name: "Pluto’s Last Comet", time: "3:31" },
    { n: 9, name: "‘87 Stingray", time: "2:21" },
    { n: 10, name: "Hurt From Mercury", time: "3:24" },
    { n: 11, name: "Last Kiss Of Nebulon", time: "4:19" },
  ],
  "Come Over When You're Sober, Pt.1": [
    { n: 1, name: "Benz Truck (гелик)", time: "2:40" },
    { n: 2, name: "Save That Shit", time: "3:52" },
    { n: 3, name: "Awful Things", time: "3:34" },
    { n: 4, name: "U Said", time: "3:44" },
    { n: 5, name: "Better Off (Dying)", time: "2:35" },
    { n: 6, name: "The Brightside", time: "3:36" },
  ...
  "Carrie & Lowell": [
    ...
    { n: 4, name: "Drawn to the Blood", time: "3:18" },
    { n: 5, name: "Eugene", time: "2:27" },
    { n: 6, name: "Fourth of July", time: "4:39", fav: true },
    { n: 7, name: "The Only Thing", time: "4:44", fav: true },
    { n: 8, name: "Carrie & Lowell", time: "3:15" },
    { n: 9, name: "John My Beloved", time: "5:05" },
    { n: 10, name: "No Shade in the Shadow of The Cross", time: "2:41" },
    { n: 11, name: "Blue Bucket of Gold", time: "4:45" },
  ],
  "Wiped Out!": [
    { n: 1, name: "A Moment of Silence", time: "0:30" },
    { n: 2, name: "Prey", time: "4:43" },
    { n: 3, name: "Cry Baby", time: "3:55" },
    { n: 4, name: "Wiped Out!", time: "6:13" },
    { n: 5, name: "The Beach", time: "4:15" },
    { n: 6, name: "Daddy Issues", time: "4:20" },
    { n: 7, name: "Baby Came Home 2 / Valentines", time: "6:31" },
    { n: 8, name: "Greetings from Califournia", time: "4:04" },
    { n: 9, name: "Ferrari", time: "3:04" },
    { n: 10, name: "Single", time: "4:22" },
    { n: 11, name: "R.I.P. 2 My Youth", time: "3:25" },
  ],
};
