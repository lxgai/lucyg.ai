...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      { kind: "p", text: "I'm going back to RSS. I'm linking out more. I'm letting the dates show. I'm putting a section divider that says SECTION A · BLOG because the small joke of cataloging a personal site like a library card is, to me, the whole point." },
...
export const PROJECTS: Project[] = [
  {
    ...
    entries: [
      ...
      { date: "03 · 28 · 26", h: "What it became", b: "Not a portfolio, not a blog, not really a journal - something between all three. The thing I keep coming back to is the section dividers. Tiny monospace labels. SECTION B · PROJECTS. They make it feel filed, which is what I wanted." },
    ],
  },
  {
    year: "2025",
